...
export const Title: React.FC<TitleProps> = ({ title, index, onEdit, onDelete, removeButton }) => {
            ...
            <div className='flex justify-between'>
                ...
                {removeButton && ( 
                    <div className='flex justify-between w-[10%]'>
                        <button onClick={handleEdit}><SVGIcon className="bg-white shadow-[1px_13px_10px_-2px_rgba(34,60,80,0.13)] text-black cursor-pointer text-[15px] rounded-[80px] w-[30px] h-[30px] flex justify-center items-center" name="edit" /></button>
                        <button onClick={handleDelete}><SVGIcon className="bg-white shadow-[1px_13px_10px_-2px_rgba(34,60,80,0.13)] text-black cursor-pointer text-[15px] rounded-[80px] w-[30px] h-[30px] flex justify-center items-center" name="delete" /></button>
                    </div>
                )}
            </div>
            {isEditing ? (
                    ...
                    <div className='flex items-center justify-center min-h-screen'>
                        <div className='relative bg-white xl:w-[40%] lg:w-[50%] md:w-[60%] w-[90%] mx-auto shadow-lg rounded-[20px] p-[20px]'>
                            ...
                            <div className='pt-4 space-x-5'>
                                ...
                                <button onClick={handleCancel} className='bg-white shadow-[1px_13px_10px_-2px_rgba(34,60,80,0.13)] text-black cursor-pointer text-[15px] rounded-[80px] px-[30px] py-2'>Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
